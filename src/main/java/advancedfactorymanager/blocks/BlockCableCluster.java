...
public class BlockCableCluster extends BlockCamouflageBase
{
    ...
    {
        sideIcon = register.registerIcon(AdvancedFactoryManager.RESOURCE_LOCATION + ":cable_cluster");
        frontIcon = register.registerIcon(AdvancedFactoryManager.RESOURCE_LOCATION + ":cable_cluster_front");
        sideIconAdv = register.registerIcon(AdvancedFactoryManager.RESOURCE_LOCATION + ":cable_cluster_adv");
        frontIconAdv = register.registerIcon(AdvancedFactoryManager.RESOURCE_LOCATION + ":cable_cluster_adv_front");
    }
