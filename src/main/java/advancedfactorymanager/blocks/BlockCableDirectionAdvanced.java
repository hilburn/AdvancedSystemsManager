...
public abstract class BlockCableDirectionAdvanced extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister register) {
        activeIcon = register.registerIcon(AdvancedFactoryManager.RESOURCE_LOCATION + ":" + getFrontTextureName(false));
        advancedActiveIcon = register.registerIcon(AdvancedFactoryManager.RESOURCE_LOCATION + ":" +  getFrontTextureName(true));
        inactiveIcon = register.registerIcon(AdvancedFactoryManager.RESOURCE_LOCATION + ":" + getSideTextureName(false));
        advancedInactiveIcon = register.registerIcon(AdvancedFactoryManager.RESOURCE_LOCATION + ":" + getSideTextureName(true));
    }
