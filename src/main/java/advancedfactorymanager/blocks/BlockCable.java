...
public class BlockCable extends Block
{
    public BlockCable()
    {
        ...
        setBlockName(AdvancedFactoryManager.UNLOCALIZED_START + ModBlocks.CABLE_UNLOCALIZED_NAME);
        setHardness(0.4F);
    }
    ...
    {
        blockIcon = register.registerIcon(AdvancedFactoryManager.RESOURCE_LOCATION + ":cable");
    }
