...
public class GLGlyphMetric {
	 ...
	 * @param h
	 *            The character's height. Used to compute the size of the glyph
	 *            on the screen and the size of the texture region.
	 * @param a
	 *            The character's ascent (ie, the distance from the baseline of
	 *            the character to the top of the character). Used to calculate
	 *            the vertical offset of the rendered character.
	 * @param u
	 *            The u origin-coordinate of the texture
	 * @param v
	 *            The v origin-coordinate of the texture
	 */
