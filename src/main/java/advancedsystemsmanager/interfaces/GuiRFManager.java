package advancedsystemsmanager.interfaces;
...
import advancedsystemsmanager.tileentities.TileEntityManager.Button;
...
public class GuiRFManager extends GuiManager
{
    ...
    private static final ResourceLocation COMPONENTS = new ResourceLocation("asm", "textures/gui/FlowComponents.png");
